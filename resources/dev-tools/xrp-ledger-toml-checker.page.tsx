        ...
        <main className="main col-lg-9" role="main" id="main_content_body">
            <section className="container-fluid">
                <div className="p-3">
                    ...
                    <XrplLink href="../../docs/references/xrp-ledger-toml" intention="neutral"><code>{translate(`xrp-ledger.toml`)}</code>{translate('resources.dev-tools.toml-checker.p.part2', ` file`)}</XrplLink>{translate('resources.dev-tools.toml-checker.p.part3', `.`)}</p>
                </div>
