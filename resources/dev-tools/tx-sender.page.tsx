                ...
                <section className="container-fluid pt-3 p-md-3">
                    ...
                    <div className="content">
                        <p>{translate("resources.dev-tool.tx-sender.content.part1", "This tool sends transactions to the ")}
                            <XrplLink href="../xrp-faucets" intention="neutral">{translate("XRP Testnet")}</XrplLink>
                        ...
                        <form>
                            ...
                            <TransactionButton 
                                ...
                                {{
                                    ...
                                    units: "drops of XRP",
                                    longerDescription: (<div>{translate("resources.dev-tool.tx-sender.send-xrp-desc.part1", "Send a ")}<XrplLink href="../../docs/tutorials/payments/send-xrp" intention="neutral">{translate("resources.dev-tool.tx-sender.send-xrp-desc.part2", "simple XRP-to-XRP payment")}</XrplLink>{translate("resources.dev-tool.tx-sender.send-xrp-desc.part3", ".")}</div>),
                                }}
                                inputSettings={
                                {
                            ...
                            <TransactionButton 
                                ...
                                {{
                                    ...
                                    <XrplLink href="/docs/concepts/payment-types/partial-payments" intention="neutral">{translate("partial payments")}</XrplLink>{translate(".")}</div>,
                            ...
                            <TransactionButton
                                ...
                                {{
                                    ...
                                    longerDescription: (<div>{translate("Create a ")}<XrplLink href="/docs/concepts/payment-types/escrow" intention="neutral">{translate("time-based escrow")}</XrplLink>
                            ...
                            */}
                            <TransactionButton
                                ...
                                content={{
                                    ...
                                    longerDescription: (<div>{translate("Create a ")}<XrplLink href="../../docs/concepts/payment-types/payment-channels" intention="neutral">{translate("payment channel")}</XrplLink>
                            ...
                            <TransactionButton
                                ...
                                content={{
                                    ...
                                    <XrplLink href="../../docs/concepts/tokens/fungible-tokens#trust-lines" intention="neutral">{translate("trust line")}</XrplLink>{translate(" to ")}
                            ...
                            <TransactionButton
                                ...
                                content={{
                                    ...
                                    <XrplLink href="../../docs/concepts/tokens/fungible-tokens#trust-lines" intention="neutral">{translate("trust line")}</XrplLink>
