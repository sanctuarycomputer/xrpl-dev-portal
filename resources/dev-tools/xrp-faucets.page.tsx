        ...
        <main className="main col-md-7 col-lg-6 order-1" role="main" id="main_content_body">
          <section className="container-fluid pt-3 p-md-3">
            ...
            <div className="content">
                <p>{translate("resources.dev-tool.faucet.content.part1", "These ")}<XrplLink href="../../docs/concepts/networks-and-servers/parallel-networks" intention="neutral">{translate("resources.dev-tool.faucet.content.part2", "parallel XRP Ledger test networks")}</XrplLink> {translate("resources.dev-tool.faucet.content.part3", "provide platforms for testing changes to the XRP Ledger and software built on it, without using real funds.")}</p>
